      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Button 
              className="bg-gradient-hero text-white border-0 hover:scale-105 transition-all duration-300"
            >
              Book Now
            </Button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden border-t border-border bg-background/95 backdrop-blur-md animate-fade-in">
            <div className="px-4 py-4 space-y-4">
              ...
              <Button 
                className="w-full bg-gradient-hero text-white border-0 hover:scale-105 transition-all duration-300"
              >
                Book Now
              </Button>
            </div>
